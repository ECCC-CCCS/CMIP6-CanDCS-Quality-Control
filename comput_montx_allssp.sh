...
for year in ${times}
do
cdo -b 64 ymonmax -selyear,$year ${fld} ${output}/annual_${year}_${fld}
done

done

ncrcat ${output}/annual_* ${output}/${var}_mtxx_${model}_${ssp}_1950-2100.nc
rm ${output}/annual_*

ncatted -h -a history,global,d,, ${output}/${var}_mtxx_${model}_${ssp}_1950-2100.nc
